...
public class GetFoodParameterizedTest {
    ...
    public void testCatGetFood() throws Exception {
        ...
        Assert.assertTrue(barsik.getFood().contains(food2));
        Assert.assertTrue(barsik.getFood().contains(food3));
    }
    ...
    public void testFelineEatMeat() throws Exception {
        ...
        Assert.assertTrue(feline.eatMeat().contains(food2));
        Assert.assertTrue(feline.eatMeat().contains(food3));
    }
    ...
    public void testLionGetFood() throws Exception {
        ...
        Assert.assertTrue(simba.getFood().contains(food2));
        Assert.assertTrue(simba.getFood().contains(food3));
    }
}
